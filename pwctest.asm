...
_pwctest:     file format elf32-i386
...
int main(int argc, char *argv[]){
  ...
  13:	6a 01                	push   $0x1
  15:	e8 68 04 00 00       	call   482 <semaphore_init>
  1a:	89 c6                	mov    %eax,%esi
    printf(1, "Global initial value is 4\n");
  1c:	58                   	pop    %eax
  1d:	5a                   	pop    %edx
  1e:	68 b9 08 00 00       	push   $0x8b9
  23:	6a 01                	push   $0x1
  25:	e8 26 05 00 00       	call   550 <printf>
    printf(1, "Parent: begin \n");
  2a:	59                   	pop    %ecx
  2b:	5b                   	pop    %ebx
  2c:	68 d4 08 00 00       	push   $0x8d4
  31:	6a 01                	push   $0x1
  33:	e8 18 05 00 00       	call   550 <printf>

    global = 4;

    void *stack = (void*)malloc(PGSIZE*2);
  38:	c7 04 24 00 20 00 00 	movl   $0x2000,(%esp)
    global = 4;
  3f:	c7 05 f4 0c 00 00 04 	movl   $0x4,0xcf4
  46:	00 00 00 
    void *stack = (void*)malloc(PGSIZE*2);
  49:	e8 62 07 00 00       	call   7b0 <malloc>
  ...
  65:	6a 04                	push   $0x4
  67:	e8 44 07 00 00       	call   7b0 <malloc>
  ...
  6c:	83 c4 0c             	add    $0xc,%esp
    *arg = sem_index;
  6f:	89 30                	mov    %esi,(%eax)
    clone(&child, stack, (void*)arg);
  71:	50                   	push   %eax
  72:	53                   	push   %ebx
  73:	68 00 01 00 00       	push   $0x100
  78:	e8 f5 03 00 00       	call   472 <clone>
  ...
  7f:	6a 02                	push   $0x2
  81:	56                   	push   %esi
  82:	e8 03 04 00 00       	call   48a <semaphore_wait>
  ...
  95:	58                   	pop    %eax
  96:	5a                   	pop    %edx
  97:	68 bc 09 00 00       	push   $0x9bc
  9c:	6a 01                	push   $0x1
    global = global*2; //doubles the shared value
  9e:	d1 25 f4 0c 00 00    	shll   0xcf4
    printf(1, "Parent: signaling the child with resource of 3\n");
  a4:	e8 a7 04 00 00       	call   550 <printf>
    semaphore_signal(sem_index, 3);
  a9:	59                   	pop    %ecx
  aa:	5b                   	pop    %ebx
  ab:	6a 03                	push   $0x3
  ad:	56                   	push   %esi
  ae:	e8 df 03 00 00       	call   492 <semaphore_signal>
  ...
  b5:	6a 04                	push   $0x4
  b7:	56                   	push   %esi
  b8:	e8 cd 03 00 00       	call   48a <semaphore_wait>

    printf(1, "Parent: Resource is 4, parent is executing\n");
  bd:	59                   	pop    %ecx
  be:	5b                   	pop    %ebx
  bf:	68 ec 09 00 00       	push   $0x9ec
  c4:	6a 01                	push   $0x1
  c6:	e8 85 04 00 00       	call   550 <printf>

    printf(1, "Global Value: %d\n", global);
  cb:	83 c4 0c             	add    $0xc,%esp
  ce:	ff 35 f4 0c 00 00    	pushl  0xcf4
  d4:	68 e4 08 00 00       	push   $0x8e4
  d9:	6a 01                	push   $0x1
  db:	e8 70 04 00 00       	call   550 <printf>

    printf(1, "Parent: end\n");
  e0:	5e                   	pop    %esi
  e1:	58                   	pop    %eax
  e2:	68 f6 08 00 00       	push   $0x8f6
  e7:	6a 01                	push   $0x1
  e9:	e8 62 04 00 00       	call   550 <printf>

    exit();
  ee:	e8 df 02 00 00       	call   3d2 <exit>
  f3:	66 90                	xchg   %ax,%ax
  f5:	66 90                	xchg   %ax,%ax
  f7:	66 90                	xchg   %ax,%ax
  f9:	66 90                	xchg   %ax,%ax
...
void *child(void *arg){
 ...
 107:	68 a8 08 00 00       	push   $0x8a8
 10c:	6a 01                	push   $0x1
 10e:	e8 3d 04 00 00       	call   550 <printf>
    int index = *(int*)arg;
 113:	8b 45 08             	mov    0x8(%ebp),%eax
 116:	8b 18                	mov    (%eax),%ebx
    global++; //adds 1 to global
 118:	83 05 f4 0c 00 00 01 	addl   $0x1,0xcf4
    printf(1, "Child: signaling the parent with resource of 2\n");
 11f:	58                   	pop    %eax
 120:	5a                   	pop    %edx
 121:	68 04 09 00 00       	push   $0x904
 126:	6a 01                	push   $0x1
 ...
 12f:	6a 01                	push   $0x1
 131:	53                   	push   %ebx
 132:	e8 5b 03 00 00       	call   492 <semaphore_signal>
    semaphore_wait(index, 3); //waits until parent adds 3 resources
 137:	58                   	pop    %eax
 138:	5a                   	pop    %edx
 139:	6a 03                	push   $0x3
 13b:	53                   	push   %ebx
 13c:	e8 49 03 00 00       	call   48a <semaphore_wait>
 ...
 14f:	58                   	pop    %eax
 150:	5a                   	pop    %edx
 151:	68 60 09 00 00       	push   $0x960
 156:	6a 01                	push   $0x1
    global = global + 5;
 158:	83 05 f4 0c 00 00 05 	addl   $0x5,0xcf4
    printf(1, "Child: Signaling the parent with resource of 4\n");
 ...
 166:	6a 04                	push   $0x4
 168:	53                   	push   %ebx
 169:	e8 24 03 00 00       	call   492 <semaphore_signal>
    exit();
 16e:	e8 5f 02 00 00       	call   3d2 <exit>
...
printf(int fd, const char *fmt, ...)
{
 ...
 704:	e9 8f fe ff ff       	jmp    598 <printf+0x48>
          s = "(null)";
 709:	bb 18 0a 00 00       	mov    $0xa18,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 721:	a1 e8 0c 00 00       	mov    0xce8,%eax
{
 ...
 75d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 75f:	a3 e8 0c 00 00       	mov    %eax,0xce8
}
 764:	5b                   	pop    %ebx
 765:	5e                   	pop    %esi
 766:	5f                   	pop    %edi
 ...
 776:	72 ce                	jb     746 <free+0x26>
{
 ...
 797:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 79a:	a3 e8 0c 00 00       	mov    %eax,0xce8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7bc:	8b 15 e8 0c 00 00    	mov    0xce8,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7ff:	73 47                	jae    848 <malloc+0x98>
    ...
    if(p == freep)
 801:	39 05 e8 0c 00 00    	cmp    %eax,0xce8
 ...
 826:	e8 f5 fe ff ff       	call   720 <free>
  return freep;
 82b:	8b 15 e8 0c 00 00    	mov    0xce8,%edx
 ...
 854:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 857:	89 15 e8 0c 00 00    	mov    %edx,0xce8
}
 ...
 869:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 870:	c7 05 e8 0c 00 00 ec 	movl   $0xcec,0xce8
 877:	0c 00 00 
 87a:	c7 05 ec 0c 00 00 ec 	movl   $0xcec,0xcec
 881:	0c 00 00 
    base.s.size = 0;
 884:	b8 ec 0c 00 00       	mov    $0xcec,%eax
 889:	c7 05 f0 0c 00 00 00 	movl   $0x0,0xcf0
 890:	00 00 00 
